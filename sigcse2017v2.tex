...
Participants in the survey were asked if they encouraged students in the first programming course to use environments and/or tools beyond simple text editors and command line compilers. The majority of participants (74.4\%) responded yes and of those, the majority (59.6\%) use one tool or environment. See Table~\ref{tab:numTools} for more details.
...
Conversely, \cite{mason+cooper:2014} asked participants: ``what steps do you take to try to determine whether students have received unauthorised assistance on assignments?'' but didn't give the results  in their paper. We
