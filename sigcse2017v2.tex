...
science degrees, this school curriculum reform has had uncertain
(and emerging) impact on the delivery of their undergraduate
programmes, with the diversity of educational background of applicants
likely to increase before it narrows: it is certainly possible now for
...
Over the past few years, there has been increasing scrutiny of the
...
employability. In February 2015, the
...
the evolving demands of high-quality learning \& teaching for computer
...
``Other'' and specify a language not included in the list. The
...
\begin{figure}[ht]
\begin{center}
\subimport{plots/}{toolPercentCompare.tex}\vskip-18pt
...
option to specify ``Other''. Of the 24 provided, 12 were chosen at
least once. The relative popularity of IDEs and tools is shown in
Figure~\ref{fig:tools}. The most popular tool/IDE in the survey was
Eclipse, reported in 37.5\% of courses and scoring 25.0\% of tool/IDE
instances, and 26.8\% when weighted by students. Following this is ``no tool/IDE'', which accounts for 27.5\% of courses. The second most popular tool/IDE is BlueJ, which was reported in
22.5\% of courses and scored 15.0\% of tool/IDE instances, and 15.5\% when
weighted by students. Participants were also asked why each tool/IDE
was chosen for their course, and asked to select from a list of
reasons. The results of this are give in
...
We  asked participants: ``what steps do you take to try to determine whether students have received unauthorised assistance on assignments?''. The details are in the full paper, but range from ``notice unlikely similarities'' (59.1\% of the 66 instructors who responded to this question) to ``interview some students/groups at random'', selected by only 5 instructors. %{\bf @Ellen: is this right - I've corrected the percentage and now it is.} 
...
15\%, the most popular named product. In the UK, ``None'' is second, ``Other'' is sixth
and Idle eighth.
...
Cardiff and Exeter) for funding the  survey.  % HGD deleted "underpinning"
% bib
