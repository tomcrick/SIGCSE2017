...
using two and three respectively; very few (c.5\%) used four or more,
...
Eclipse, reported in 37.5\% of courses and scoring 30.6\% of tool/IDE
instances, and 32.1\% when weighted by the number of students that use
one or more tool/IDE. This is followed by BlueJ, which was reported in
\% of courses and scored 18.4\% of tool/IDE instances, and 18.6\% when
