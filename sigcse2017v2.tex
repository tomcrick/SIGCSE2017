...
and Idle seventh, with no ``None'' @Ellen: is that right?{\bf{[@Tom/James?: No, ``none'' scores second for us 28.2\% but I didn't think to include it in graph. I can add it if you like.]}}.
