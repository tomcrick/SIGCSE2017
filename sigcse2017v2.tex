...
Participants in the survey were asked if they encouraged students in the first programming course to use environments and/or tools beyond simple text editors and command line compilers. The majority of participants (74.4\%) responded that they did and of those that do, the majority (59.6\%) use only one tool or IDE. See Table~\ref{tab:numTools} for more details on the number of tools and IDEs used.
...
Participants were also asked why each tool/IDE was chosen for their course, and asked to select from a list of reasons. The results of this are give in Figure~\ref{fig:reasonsTools}, for all tools and IDEs grouped together, and for the two most popular choices, Eclipse and BlueJ. Instructors were also asked whether the tool/IDE was used for an initial part of the first programming course or throughout the whole of the course; and whether it was used in any other course in the degree (Figure~\ref{fig:toolreuse}). 
...
Conversely, \cite{mason+cooper:2014} asked participants: ``what steps do you take to try to determine whether students have received unauthorised assistance on assignments?'' but didn't give the results  in their paper. {\bf{[@James: this was one of the questions given to me by Raina, but it's possible that it was only added to the list after [8] was published. So might not be correct to say that it was asked by them.]}} We
